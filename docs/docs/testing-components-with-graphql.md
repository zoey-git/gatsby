...
The method above works for page queries, as you can pass the data infdirectly to
...
pure because its return value is entirely dependent on the props passed it.
